...
public class Problem_2 {
    ...
    for (String file_name : args) {
      try {
        ...
        while (line != null) {
          ...
          System.out.println("Kth = " + list_kth.kth);

          Node kth_node_from_last = find_kth_to_last_1(linked_list_1, list_kth.kth);
          System.out.println(list_kth.kth + "kth node from last: ");
          if (kth_node_from_last == null) {
            System.out.println("does not exist");
          } else {
            System.out.println(kth_node_from_last.data);
          }
  ...
  private static Node find_kth_to_last_1(Node head, int kth) {
    if (head == null) {
      return head;
    }
